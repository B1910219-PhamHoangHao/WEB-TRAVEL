	      ...
	      <div class="section row">
	      	...
	      	if ($search){
				...
				<div class="col-12 col-sm-5 col-md-3 images_1_of_4 card">
				     ...
				     <div class="button"><span><a href="details.php?proid=<?php echo $result['p_id']?>&qty=<?php echo $result['p_quantity']?>&sold=<?php echo $result['p_soldout']?>&product_remain=<?php echo $result['p_remain']?>" class="details">Chi tiết</a></span></div>
				</div>
				<?php
			}
		}
