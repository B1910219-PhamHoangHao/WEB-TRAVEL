    ...
    <div class=" container_12">
        <div class="grid_12 header-repeat">
            <div id="branding">
				...
				<div class="floatleft middle">
					<h1>WEB TRAVEL</h1>
					<p>Tận hưởng kì nghỉ bằng những chuyến đi thật ý nghĩa !</p>
				</div>
                <div class="floatright">
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            ...
                            <!-- Kiểm tra biến action và gọi phương thức destroy() để hủy session trở về login-->
                            <?php   
        ...
        <div class="grid_12">
            <ul class="nav main">
				...
				<li class=""><a href="inbox.php"><span>Đơn đặt tour</span></a></li>
